...
int32_t create_sop1(int32_t op, int32_t sdst, int32_t s0){
 ...
 void create_mtbuf(int32_t op, int32_t offset,int32_t offen,int32_t idxen,
   ...
   * 2nd 32bit word
   * | SOFFSET(8) | TFE(1) | SLC(1) | RESERVED(1) | SRSRC(5) | VDATA(8) |VADDR(8)|
   */
   inst[0] = 0xE8000000;
   inst[1] = 0x00000000;
   offen = offen << 12;
 ...
 int32_t run_vop_program_neko(int32_t insts[],int32_t num_insts, 
   ...
   * Send "start execution" command, responds to memory requests and waits for 
  ...
  /* Load vector registers with data (replicating the data for every word of the
   * register) */ 
